# Evidências
Este documento contém as evidências de execução do desafio final.
...
Nova estrutura do arquivo JSON

![](/Sprint-10/Evidências/Novo_json.png)

Visão dos scripts glue desenvolvidos durante todo o desafio final
